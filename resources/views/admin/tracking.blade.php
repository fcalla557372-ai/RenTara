...
<form method="GET" class="mb-4">
    <div class="row g-2 align-items-end">
        ...
        <div class="col-12 col-md-3 d-grid d-md-flex gap-2">
            ...
            <a href="{{ route('admin.tracking') }}" class="btn btn-outline-secondary btn-sm flex-fill" style="border-radius:8px;">
                Reset
            </a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td style="display:flex; align-items:center; gap:.85rem;">
                        ...
                        @if($b->payment_status === 'Pending Payment')
                            ...
                            <form method="POST" action="{{ route('admin.tracking.cancel', $b) }}"
                        ...
                        @elseif(in_array($b->payment_status, ['Payment Confirmed', 'Partial Payment'], true))
                            <form method="POST" action="{{ route('admin.tracking.markReturn', $b) }}" style="display:contents;">
                                @csrf
                                <button type="submit" style="background:none; border:none; padding:0; font-size:.8rem; font-weight:600; cursor:pointer; text-decoration:underline; text-underline-offset:3px; color:#166534;">
                        ...
                        <div class="modal-content" style="border-radius:16px; border:none;
                            ...
                            <div class="modal-body" style="padding:0; background:#F8FAFC;">
                                ...
                                <div class="row g-0">
                                    ...
                                    {{-- LEFT COLUMN: Info --}}
                                    <div class="col-lg-5"
                                         style="padding:1.5rem; border-right:1px solid #E2E8F0;
                                                background:#fff;">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <div class="d-flex justify-content-between py-2 mt-1"
                                                 style="background:#FEF3C7; border-radius:8px;
                                                        padding:.5rem .75rem !important; margin-top:.25rem;">
                                        ...
                                        <div>
                                            ...
                                            {!! $row('License Expiry', $b->license_expiry->format('M d, Y')) !!}
                            ...
                            <div class="modal-footer"
                                 style="border-top:1px solid #E2E8F0; padding:.75rem 1.5rem; background:#fff;
                                        border-radius:0 0 16px 16px; justify-content:space-between;">
