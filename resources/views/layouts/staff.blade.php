...
<head>
    ...
    <title>RenTara — @yield('title', 'Staff')</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        body { font-family: 'DM Sans', sans-serif; background: var(--page-bg); color: var(--text); }
        ...
        .brand-name { font-family: 'Playfair Display', serif; font-size: 1.15rem; font-weight: 700; line-height: 1; }
        .brand-ren { color: #F1F5F9; }
        .brand-tara { color: #F59E0B; }
        .brand-sub  { margin-top: 3px; font-size: .58rem; font-weight: 800; letter-spacing: 2px; text-transform: uppercase; color: #94A3B8; }
        ...
        .sb-nav li a {
            ...
            transition: background .2s; perspective: 600px;
        }
        .sb-nav li a:hover, .sb-nav li a.active { background: var(--sb-active-bg); }
        ...
        .nav-icon-wrap i { font-size: 1.25rem; color: var(--sb-text); transition: color .3s; }
        ...
        .sb-nav li a:hover .nav-text, .sb-nav li a.active .nav-text { color: var(--sb-active-text); }
        ...
        .sb-footer { width: 100%; border-top: 1px solid var(--sb-border); padding: 16px 12px; overflow: hidden; }
        ...
        .topbar-date  { font-size: .8rem; color: var(--muted); font-weight: 500; }

        .page-body { padding: 24px 24px 32px; }

        .stat-card {
            background: var(--card-bg); border-radius: 14px; padding: 1.4rem 1.5rem;
            box-shadow: 0 1px 3px rgba(0,0,0,.06), 0 4px 16px rgba(0,0,0,.05);
            border: 1px solid var(--border);
        }
        .table-card { background: var(--card-bg); border-radius: 14px; border: 1px solid var(--border); box-shadow: 0 1px 3px rgba(0,0,0,.05); overflow: hidden; }
        .chart-card { background: var(--card-bg); border-radius: 14px; padding: 1.5rem; border: 1px solid var(--border); box-shadow: 0 1px 3px rgba(0,0,0,.05); }

        .table thead th { background:#F8FAFC;color:var(--muted);font-size:.72rem;font-weight:700;text-transform:uppercase;letter-spacing:.6px;border-bottom:1px solid var(--border);padding:.85rem 1rem; }
        ...
        @media (max-width: 992px) {
            ...
            .stat-card, .chart-card, .table-card { border-radius:10px; }
        }
...
<aside class="sidebar">
    ...
    <ul class="sb-nav">
        <li>
            <a href="{{ route('staff.tracking') }}"
               class="{{ request()->routeIs('staff.tracking') ? 'active' : '' }}">
                <div class="nav-icon-wrap"><i class='bx bx-map-alt'></i></div>
                <span class="nav-text">Tracking</span>
            </a>
        </li>
        <li>
            <a href="{{ route('staff.car-inventory') }}"
               class="{{ request()->routeIs('staff.car-inventory') ? 'active' : '' }}">
...
<div class="main-content">
    <div class="topbar">
        <span class="topbar-title">@yield('title', 'Staff Panel')</span>
